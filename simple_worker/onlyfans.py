...
def onlyfans_downloader_script(authData):
    ...
    r = {
        ...
        "checksum_indexes": [11,17,13,20,15,39,35,14,26,14,15,19,36,14,10,28,34,36,24,7,30,0,31,37,35,34,7,1,5,35,30,27],
        "checksum_constants": [115,100,-92,138,-141,100,146,120,103,111,-107,-96,103,50,-136,-66,-87,102,-71,-107,-88,71,123,-109,95,91,-78,-112,-81,76,71,-72],
    ...
    for M in SELECTED_MODELS:
        ...
        cur_count = download_posts(cur_count, video_posts, False,row, authData['user-id'])
